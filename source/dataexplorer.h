...
#define CUSTOMIZE_RESTORE_LOC        "Do you want to maintain connections and customizations that were done by you or a third-party vendor?"
#define CUSTOMIZE_RESTOREDONE_LOC    "The DataExplorer table has been restored to the original. A backup of the original table was saved to: "
...
******************* Microsoft Sedna (v2.0) Localizations ******************* 
* Used when querying VFP data in the Query dialog
#DEFINE ROWS_RETURNED                 "row(s) returned"

* Used to message developer when dragging and dropping columns, tables, views (see cDataExplorer.DropNode()
#DEFINE BAD_FIELDMAPPING              "The field mapping is not set up properly for the object being instantiated:"
#DEFINE DATATYPE_FIELDMAPPING         "Field mapping in question is for data type:"
#DEFINE NEED_TO_SELECT_UPSIZINGWIZARD "Please select the proper UpsizingWizard.app file."

#DEFINE CUSTOMIZE_BACKUP_LOC          "Do you want to back up the DataExplorer table?"
#DEFINE CUSTOMIZE_BACKUPDONE_LOC      "The DataExplorer table has been backed up to:"
#DEFINE CUSTOMIZE_BACKUPNOTDONE_LOC   "The DataExplorer table was not backed up!"

* Button Captions on main Data Explorer Window
#DEFINE BUTTON_CAPTION_ADDCONNECTION_LOC      "\<Add Connection"
#DEFINE BUTTON_CAPTION_OPTIONS_LOC            "\<Options"
#DEFINE BUTTON_CAPTION_REFRESH_LOC            "\<Refresh"

* Button Icons on main Data Explorer Window
#DEFINE BUTTON_ICON_ADDCONNECTION_LOC         "AddConnection.bmp"
#DEFINE BUTTON_ICON_OPTIONS_LOC               "Options.bmp"
#DEFINE BUTTON_ICON_REFRESH_LOC               "Refresh.bmp"


******************* VFPX (v3.x) Localizations ******************* 